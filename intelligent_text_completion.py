...
# NOTE: This is a slightly modified version, removing the auto-completed
# brackets but leaving everything else. FOr compatibility with built-in
# bracket completion in gedit 3.10.4
